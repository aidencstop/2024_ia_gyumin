...
def counselor_studdashboarddetail(request, id):
    ...
    if subjects_strength == 1:
        subjects_query = "Please write a sentence stating that the courses the student has currently completed are sufficient to apply to the desired major, \'"+student.major.name+"\'. You must also mention that the student's "+activity_trait_dict['subjects']+" is clearly revealed through the subjects completed."
    else:
        subjects_query = "Please write a sentence stating that the courses the student has currently completed are not sufficient to apply to the desired major, \'"+student.major.name+"\'. You must also mention that the student's "+activity_trait_dict['subjects']+" will be well revealed if the student completes the subject, especially \'"+fail_subject_list[0]+"\'."
    ...
    if awards_strength == 1:
        awards_query = "Please write a sentence stating that the current student's awards are sufficient to apply to the desired school, "+student.university.name+". Please also mention that the student's award history reflects the student's "+activity_trait_dict['awards']+"."
    else:
        awards_query = "Please write a sentence stating that the current student's award history is not sufficient to apply to the desired school, "+student.university.name+". Please also mention that adding a few more awards will highlight the student's "+activity_trait_dict['awards']+"."
    ...
    if isa_strength == 1:
        isa_query = "Please write a sentence explaining that the student's in-school activities meet the standards of the desired school, "+student.university.name+". Please also mention that the student's in-school activities can show the student's "+activity_trait_dict['isa']+"."
    else:
        isa_query = "Please write a sentence explaining that the student's in-school activities are somewhat lacking compared to the standards of the desired school, "+student.university.name+". Please also mention that if the student adds in-school activities, the student can show the student's "+activity_trait_dict['isa']+"."
    ...
    if ea_strength == 1:
        ea_query = "Write a sentence explaining that the student's extracurricular activities meet the standards of the desired school, "+student.university.name+". Also mention that the student's extracurricular activities can show the student's "+activity_trait_dict['ea']+"."
    else:
        ea_query = "Write a sentence explaining why the student's extracurricular activities fall short of the standards of the desired school, "+student.university.name+". Please also mention that if the student adds extracurricular activities, it can show the student's "+activity_trait_dict['ea']+"."
    ...
    if va_strength == 1:
        va_query = "Please write a sentence explaining that your student's volunteer activities meet the standards of the desired school, "+student.university.name+". Also mention that the student's volunteer activities show the student's "+activity_trait_dict['va']+"."
    else:
        va_query = "Please write a sentence explaining why the student's volunteer activities do not meet the standards of the desired school, "+student.university.name+". Please also mention that if the student adds volunteer activities, it can show the student's "+activity_trait_dict['va']+"."
